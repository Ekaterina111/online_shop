  ...
  Widget build(BuildContext context) {
   ...
   child:  ListView.builder(
         ...
         itemBuilder: (BuildContext context, int index) {
             return Card(
                 ...
                 leading: Container(
                     width: 36,
                     height: 36,
                     child: Image.network(_products.elementAt(index).image, 
                     fit: BoxFit.cover,
                     ),
                  ),
                 ...
                 onTap: () {
                   Navigator.push(
                       context, CupertinoPageRoute(
                           builder: (_) => Product(model: _products.elementAt(index))));
                 },
                 ),
              );
         },
     ...
     Padding(
         ...
         onPressed: () {}, 
         child: Text("Оформить заказ на сумму "+ DataDumper.getCartPrice().toString() + "руб"),
